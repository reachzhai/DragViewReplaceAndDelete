...
public class DragGridView extends GridView {
    ...
    private void onDragItem(int moveX, int moveY) {
        ...
        Log.e("aaa zhailong","onDragItem : ( "+ mWindowLayoutParams.x  + " , "+ mWindowLayoutParams.y +" )");
        mDragAdapter.dragItems(mWindowLayoutParams.x, mWindowLayoutParams.y);
...
//        }
    ...
    private void onStopDrag(int moveX, int moveY) {
        ...
        Log.e("stop zhailong",moveX + " : " + moveY + " drag: " + mDragPosition);
        mDragAdapter.releaseItem(x,y,mDragPosition);
    ...
    public interface DragGridBaseAdapter {
        ...
        void releaseItem(int x, int y, int curPostion);
    }
}
